...
export const PRODUCT_SEEDS: ProductSeed[] = [
  product({
    ...
    specs: {
      ...
      "Chassis material": "Steel frame with ventilated panels and rack mounting ears",
      "Rear cooling": "4× high-airflow fan module",
      "Power input": "110–220V AC · 550W class PSU typical (region-specific cable)",
      "Typical power draw": "Continuous draw varies with charging load — plan 200–400W class for a loaded 20-node rack (peak PSU rating higher; confirm in quote)",
      "Control uplink": "USB hub to Windows / Linux control workstation",
      "Typical dimensions": "Approx. 43.5 × 27.5 × 9 cm — confirm per phone model list",
      Weight: "Approx. 9–12 kg net (chassis + fans + PSU, phones not included) · gross carton per packing list",
      "Gross weight": "Approx. 11–14 kg per export carton (single rack, accessories included)",
      "Packing size": "Export carton approx. 50 × 35 × 25 cm (L × W × H) — confirm on packing list",
      "Lead time": "In-stock: 5–10 business days (QC + packing)",
    },
    scenarios: [
  ...
  product({
    ...
    specs: {
      ...
      Weight: "Approx. 8–11 kg net (chassis + fans + PSU, boards not included)",
      "Power input": "110–220V AC · industrial PSU sized per node count",
      "Typical power draw": "Lower per-node than full-phone racks — budget PSU tier confirmed against your motherboard count in quote",
      "Compatible boards":
  ...
  product({
    ...
    specs: {
      ...
      "Typical dimensions": "Approx. 43.5 × 27.5 × 9 cm — confirm per phone model list",
      Weight: "Approx. 9–12 kg net (chassis + fans + PSU, phones not included)",
      "Power input": "110–220V AC · PSU sized per node count in quote",
    },
    scenarios: [
  ...
  product({
    ...
    productLine: "rack-systems",
    shortDesc: "iOS lab rack chassis — Lightning/USB-C routing, charging bus, and slot layout (iPhones BYO).",
    description:
      "The iPhone Phone Farm is rack hardware engineered for real iPhone arrays: ventilated chassis, centralized charging bus, and data paths sized for iOS QA workflows. iPhones are always customer-supplied — photos on this page show chassis front/rear views and slot spacing only. Before shipment we document a cable plan matched to your iPhone generation mix (Lightning, USB-C, or mixed) and whether a macOS control station sits beside the rack.",
    features: [
      "20-slot chassis with status LED row and rear fan/PSU bay",
      "Generation-specific Lightning or USB-C cable kit quoted separately",
      "Centralized charging bus — avoids per-phone wall adapters",
      "macOS control station compatible (Mac not included)",
      "Workshop cable routing and detection test before export",
      "Pairs with Remote Control Setup for first-boot iOS lab commissioning",
    ],
    specs: {
      ...
      "Typical dimensions": "Approx. 43.5 × 27.5 × 9 cm reference — confirm per iPhone mix",
      Weight: "Approx. 8–11 kg net (chassis + fans + PSU, iPhones not included)",
      "Power input": "110–220V AC · charging bus load sized in quote",
    },
    scenarios: [
    ...
    faq: [
      { q: "Are iPhones included?", a: "No. This SKU is rack chassis and cabling hardware only. You supply iPhones matched to the quoted slot layout." },
      { q: "Do I need a Mac?", a: "Most iOS lab workflows use a macOS control station for Xcode, TestFlight, and device trust. We supply rack hardware — not the Mac." },
      { q: "Lightning and USB-C in one rack?", a: "Possible with a mixed cable kit. List every model and connector type in your quote request so sales can split slot ranges correctly." },
      { q: "Why do photos show an empty chassis?", a: "Factory photos document slot spacing, I/O panel, and cooling layout. Your devices are installed on-site after delivery." },
    ],
    priceUsd: 1280,
    stock: 5,
  ...
  product({
    ...
    productLine: "rack-systems",
    shortDesc:
      "Bare 20-slot rack chassis — steel frame with front LAN/USB panel and rear fan grille. Shipped without phones, motherboards, or hub PCB. Add catalog modules or your own.",
    description:
      "The Empty Box / Chassis is the metal rack shell used across our Box Phone Farm line — ventilated steel frame with numbered 20-position front panel, dual LAN ports, USB uplink, and OTG/USB switch. It ships without phones, motherboard nodes, or USB hub boards installed, so you can stage a custom lab, expand an existing row, or integrate buyer-supplied electronics. Workshop verifies frame squareness, vent alignment, and front I/O labeling before export packing. Optional pre-drilled slot patterns are quoted when you share device outline drawings.",
    features: [
      "20-position numbered front indicator row (slots 1–20)",
      "Front panel: LAN1 + LAN2 (RJ45), USB Type-B uplink, OTG/USB switch",
      "Rear panel: 4× high-airflow fan grille + modular PSU bay",
      "Rack mounting ears for standard cabinet installation",
      "Shipped empty — no phones, boards, or hub PCB pre-installed",
      "Compatible with catalog USB Hub, PSU, and Cooling add-ons",
    ],
    specs: {
      "Product type": "Empty rack chassis (bare metal shell)",
      "Slot capacity": "20 positions — numbered front indicator row",
      "Front panel I/O": "LAN1 + LAN2 (RJ45), USB Type-B, OTG/USB power switch",
      "Rear cooling": "4× fan ventilation grille (fans confirmed per configuration)",
      "PSU bay": "Modular rear PSU slot — add catalog PSU or buyer module",
      "Mounting": "Standard rack cabinet mounting ears",
      "Material": "Steel chassis, black industrial finish",
      "Typical dimensions": "Approx. 43.5 × 27.5 × 9 cm reference — confirm in quote",
      Weight: "Approx. 6–9 kg net (bare chassis + fans, no PSU/hub/phones)",
      "Power input": "110–220V AC when PSU module installed (PSU sold separately)",
      "Not included": "Phones, motherboard nodes, USB hub PCB, pre-wired cables",
      "Add-on modules": "USB Hub · Power Supply · Cooling — order separately or bundle in quote",
    },
    scenarios: [
    ...
    faq: [
      {
        q: "Does this include USB hub or power supply?",
        a: "No — this is the bare chassis shell. Front LAN/USB panel and rear fan grille are part of the frame. USB hub PCB, PSU, and populated device slots are added separately via catalog modules or your own hardware.",
      },
      {
        q: "What does 'empty' mean?",
        a: "Empty means no phones or motherboard nodes installed and no hub board wired. You receive the metal rack enclosure ready for your device layout.",
      },
      {
        q: "How many devices fit this chassis?",
        a: "The standard front panel supports 20 numbered positions. Final slot layout depends on your phone or motherboard model — share dimensions in the quote.",
      },
    ],
    priceUsd: 280,
    stock: 25,
